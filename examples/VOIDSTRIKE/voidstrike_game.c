...
static int h_keyboard_events,h_joystick_events,h_ctrl_events,h_space_events,h_joy_direction_events,h_joy_fire_events,h_joy_space_events,h_prev_ctrl,h_prev_space,h_prev_fire,h_prev_direction,h_window_start,h_min_fps,h_started_once,h_restart_events,h_restart_requested;
...
h_phase("playing");
#endif
px=152;py=184;invul=50;fire_wait=0;scroll=0;boss_hp=48;boss_x=128;clear_actors(bullets);clear_actors(hostile_bullets);clear_actors(enemies);clear_actors(cores);clear_actors(effects); }
