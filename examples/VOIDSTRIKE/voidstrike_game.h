...
typedef struct VoidstrikeTelemetry { int frame,score,lives,selected_module; unsigned int installed_modules; int enemies_spawned,enemies_destroyed,boss_phase,collision_invariant_failures,world_bound_invariant_failures; VoidstrikeState state; } VoidstrikeTelemetry;
